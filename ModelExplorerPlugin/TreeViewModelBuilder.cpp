...
//QList<QStandardItem*> TreeViewModelBuilder::createLevelObjectItem(Renga::IModelObjectPtr pObject) const
//{
//  assert(pObject);
...
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::createItem(const QString& name, const QString& iconPath, bool isVisible, QVariant data) const
//{
//  auto pModelObjectItem = new QStandardItem(name);
//  pModelObjectItem->setIcon(QIcon(iconPath));
//  if(!data.isNull())
//    pModelObjectItem->setData(data, TreeViewModelBuilder::ObjectIdRole);
//
...
//  pModelObjectVisibilityItem->setData(QVariant(isVisible), TreeViewModelBuilder::ObjectIdRole);
//
//  QList<QStandardItem*> itemList;
...
//}
//
//QStandardItem* TreeViewModelBuilder::createMaterialItem(const QString& name) const
//{
//  auto pMaterialItem = new QStandardItem(name);
//  return pMaterialItem;
//}
//
//QStandardItem* TreeViewModelBuilder::createMaterialLayerItem(const QString& name, int objectId, int layerIndex) const
//{
//  auto pMaterialLayerItem = new QStandardItem(name);
//
//  pMaterialLayerItem->setData(QVariant(objectId), ObjectIdRole);
//  pMaterialLayerItem->setData(QVariant(layerIndex), LayerIndexRole);
//  
//  return pMaterialLayerItem;
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::buildLevelSubtree(const int levelId, const Renga::IModelObjectCollectionPtr objCollection)
//{
//  QList<QStandardItem*> pLevelItem = createLevelObjectItem(objCollection->GetById(levelId));
//
...
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::buildMaterialsSubtree(Renga::IModelObjectPtr pModelObject) const
//{
//  Renga::IObjectWithMaterialPtr pObjectWithMaterial;
//  pModelObject->QueryInterface(&pObjectWithMaterial);
//  if (pObjectWithMaterial != nullptr && pObjectWithMaterial->HasMaterial())
//    return buildSingleLayeredMaterialSubtree(pModelObject, pObjectWithMaterial);
//
//  Renga::IObjectWithLayeredMaterialPtr pObjectWithLayeredMaterial;
//  pModelObject->QueryInterface(&pObjectWithLayeredMaterial);
//  if (pObjectWithLayeredMaterial != nullptr && pObjectWithLayeredMaterial->HasLayeredMaterial())
//    return buildMultipleLayeredMaterialSubtree(pModelObject, pObjectWithLayeredMaterial->GetLayeredMaterialId());
//
//  return buildNoMaterialSubtree(pModelObject);
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::buildSingleLayeredMaterialSubtree(Renga::IModelObjectPtr pModelObject, int materialId) const
//{
//  QStandardItem* item = createMaterialItem(QApplication::translate("me_materials", "Material"));
//  item->appendRows(buildReinforcementSubtree(pModelObject));
//
//  QList<QStandardItem*> itemList;
...
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::buildMultipleLayeredMaterialSubtree(Renga::IModelObjectPtr pModelObject, int layeredMaterialId) const
//{
//  auto pProject = m_pApplication->GetProject();
//  if (pProject == nullptr)
...
//  QList<QStandardItem*> itemList;
//
//  auto pLayerCollection = pLayeredMaterial->GetLayers();
//
//  for (int layerIndex = 0; layerIndex < pLayerCollection->Count; layerIndex++)
//    itemList.append(createMaterialLayerItem(QApplication::translate("me_materials", "Material layer"), pModelObject->Id, layerIndex));
//
//  return itemList;
//}
//
//QList<QStandardItem*> TreeViewModelBuilder::buildNoMaterialSubtree(Renga::IModelObjectPtr pModelObject) const
//{
//  QList<QStandardItem*> itemList;
//
//  itemList.append(createMaterialItem(QApplication::translate("me_materials", "No material")));
//
//  itemList.at(0)->appendRows(buildReinforcementSubtree(pModelObject));
//
//  return itemList;
//}
//
//QList<QStandardItem*> ModelTreeBuilder::buildReinforcementSubtree(Renga::IModelObjectPtr pModelObject) const
//{
//  QList<QStandardItem*> itemList;
//
//  Renga::IObjectReinforcementModelPtr pReinforcementModel;
...
//  int rebarUsageCount = pRebarUsages->Count;
//
...
//  }
//
//  auto pReinforcementUnitUsages = pReinforcementModel->GetReinforcementUnitUsages();
//  int reinforcementUnitUsageCount = pReinforcementUnitUsages->Count;
//
//  for (int i = 0; i < reinforcementUnitUsageCount; i++)
//  {
//    auto pReinforcementUnitUsage = pReinforcementUnitUsages->Get(i);
//  }
//
//  return itemList;
//}
