...
const RengaEntityUIData getRengaEntityUIData(GUID entityType)
{
  static GuidMap<RengaEntityUIData> dict{
      ...
      {Renga::ObjectTypes::LinearDimension,
       {QApplication::translate("me_modelObjects", "Dimensions"), ":/icons/Dimension"}},
      {Renga::ObjectTypes::RadialDimension,
       {QApplication::translate("me_modelObjects", "Dimensions"), ":/icons/Dimension"}},
      {Renga::ObjectTypes::DiametralDimension,
       {QApplication::translate("me_modelObjects", "Dimensions"), ":/icons/Dimension"}},
      {Renga::ObjectTypes::AngularDimension,
       {QApplication::translate("me_modelObjects", "Dimensions"), ":/icons/Dimension"}},
      ...
      {Renga::StyleTypeIds::ElectricDistributionBoardStyle,
