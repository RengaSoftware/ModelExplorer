...
{
public:
    QtPropertyPrivate(QtAbstractPropertyManager *manager) : m_enabled(true), m_modified(false), m_bold(false),  m_manager(manager) {}
    QtProperty *q_ptr;
...
/*!
    Returns whether the property is root property.
...
void QtProperty::setData(const QString &text)
{
	if (d_ptr->m_data == text)
		return;
...
/*!
    Sets the property's bold state according to the passed \a modified value.
